...
{% include figure popup=true image_path="/images/river_station_inside.jpg" alt="" caption="Hydrology Sensor." %}

{% include figure popup=true image_path="/images/river_station_inside2.jpg" alt="" caption="Hydrology Sensor." %}
